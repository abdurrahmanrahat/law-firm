...
const navLinks = [
  ...
  { name: "About", href: "/about" },
  {
    ...
    children: [
      ...
      { name: "Property & Land Law", href: "/services/property-law" },
      { name: "Corporate & Contract Law", href: "/services/corporate-law" },
      { name: "Immigration Support", href: "/services/immigration-support" },
    ],
  },
